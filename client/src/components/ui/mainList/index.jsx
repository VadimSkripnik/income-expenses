...
import RateListId from './../../page/rate/rateListId/rateId';
import RateId from './../../page/rate/rateListId/rateId';
    ...
    return (
        <div className={style.main_incomes}>
            ...
            <Routes>
                 ...
                 <Route path={":cardId/showhistory"} element={<ShowHistoryCardPageList/>}>
