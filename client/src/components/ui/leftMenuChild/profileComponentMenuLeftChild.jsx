...
const ProfileComponentMenuLeftChild = () => {
  ...
  return (
    <>
        <div className="ws-layout-row ws-align-items-start-center ws-body-1-primary main-wrap__item-child-menu" onClick={handleProfile}>
        ...
        <div className="ws-layout-row ws-align-items-start-center ws-body-1-primary main-wrap__item-child-menu" onClick={handleLogOut}>
          <div className="main-wrap__item-child-menu--icon-wrap">
