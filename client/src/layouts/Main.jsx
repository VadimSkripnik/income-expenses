...
// import AddReceiptCardPage from './../components/page/cards/addReceiptCardPage';
    ...
    return (
        ...
        <h1>Main</h1>
            <Routes>
                ...
                <Route path={"incomecategoryspage"} element={<ShowIncomeCategorysPageList/>}>
                  <Route index element={<ShowIncomeCategorysPage/>}/>
                  <Route path={":incomeCategoryId/editincomecategory"} element={<EditCategoryPage/>}/>
                </Route>
                <Route path={"addincomecategory"} element={<AddIncomeCategoryPage/>}/>
                <Route path={"ratecategoryspage"} element={<ShowRateCategorysPageList/>}>
                  <Route index element={<ShowRateCategorysPage/>}/>
                  <Route path={":rateCategoryId/editratecategory"} element={<EditRateCategoryPage/>}/>
                </Route>
